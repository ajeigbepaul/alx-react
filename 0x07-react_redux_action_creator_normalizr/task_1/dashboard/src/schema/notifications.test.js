...
describe("Notifications Normalization", () => {
  it("normalizes users entity correctly", () => {
    const userId = "5debd764a7c57c7839d722e9";
    const normalizedUser = normalizedNotifications.users[userId];
  ...
  it("normalizes messages entity correctly", () => {
    ...
    const normalizedMessage = normalizedNotifications.messages[messageGuid];
  ...
  it("normalizes notifications entity correctly", () => {
    ...
    const normalizedNotification =
      normalizedNotifications.notifications[notificationId];
